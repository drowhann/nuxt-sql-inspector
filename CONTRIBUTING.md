...
libSQL, better-sqlite3, and db0 demos use a file DB under `playground/.data` (no extra service). mysql2 demos need `MYSQL_DATABASE_URL`; without it those buttons return an error.
